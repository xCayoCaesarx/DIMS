...
WebUI.click(findTestObject('Profiles/edit - delete profiles/td_Systems Permissions_tdEditButton'))

WebUI.click(findTestObject('Profiles/edit - delete profiles/edit - delete profiles/button_Welcome, Julio Uzctegui_deleteButton'))

WebUI.click(findTestObject('Profiles/edit - delete profiles/edit - delete profiles/button_Accept'))
