...
WebUI.click(findTestObject('Competitors/Add Competitors/span_Competitors'))

WebUI.setText(findTestObject('Competitors/Edit Competitor/input competitors for search'), competitorname)

WebUI.click(findTestObject('Competitors/Edit Competitor/button_Competitors_editButton'))

WebUI.setText(findTestObject('Competitors/Edit Competitor/Page_Debt IMS/input_Competitor2nd'), competitornamemodify)

WebUI.click(findTestObject('Competitors/Add Competitors/button_Welcome, Julio Uzctegui_saveButton'))

WebUI.click(findTestObject('Competitors/Edit Competitor/button_Accept'))
