...
WebUI.setText(findTestObject('Offer Status/edit offer status/input_Offer to search'), offernamemodify)

WebUI.click(findTestObject('Offer Status/Delete offer status/td_Status_tdEditButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Offer Status/Delete offer status/button_Welcome, Julio Uzctegui_deleteButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Offer Status/Delete offer status/button_Accept'), FailureHandling.STOP_ON_FAILURE)
