...
WebUI.setText(findTestObject('Teams/Page_Debt IMS/input_Teams_p-inputtext p-component p-element'), teamname)

WebUI.click(findTestObject('Teams/Page_Debt IMS/td_Test aut modifcado'))

WebUI.click(findTestObject('Teams/Page_Debt IMS/button_Welcome, Julio Uzctegui_deleteButton'))

WebUI.click(findTestObject('Teams/Page_Debt IMS/button_Accept delete'))
