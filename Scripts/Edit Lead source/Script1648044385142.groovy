...
WebUI.click(findTestObject('Object Repository/Create Lead/Page_Debt IMS/edit -delete lead source/Page_Debt IMS/button_POST Specification_editButton'))

WebUI.setText(findTestObject('Create Lead/Page_Debt IMS/edit -delete lead source/Page_Debt IMS/input_Lead Source'), leadname)

WebUI.selectOptionByValue(findTestObject('Object Repository/Create Lead/Page_Debt IMS/edit -delete lead source/Page_Debt IMS/select_OnOff'), 
    'false', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Create Lead/Page_Debt IMS/edit -delete lead source/Page_Debt IMS/select_YesNo'), 
    'false', true)
...
WebUI.click(findTestObject('Object Repository/Create Lead/Page_Debt IMS/edit -delete lead source/Page_Debt IMS/button_Accept'))
