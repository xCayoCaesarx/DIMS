...
WebUI.setText(findTestObject('Competitors/Edit Competitor/input competitors for search'), competitornamemodify)

WebUI.click(findTestObject('Competitors/Delete competitor/Choose to delete'))
