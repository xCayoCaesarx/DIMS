...
WebUI.setText(findTestObject('Profiles/edit - delete profiles/edit - delete profiles/input_Profiles to search'), name)

WebUI.click(findTestObject('Profiles/edit - delete profiles/button_Systems Permissions_editButton'))

WebUI.setText(findTestObject('Profiles/edit - delete profiles/edit - delete profiles/Page_Debt IMS/input_Name Profile to edit'), 
    namemodify)

WebUI.click(findTestObject('Profiles/edit - delete profiles/edit - delete profiles/button_Welcome, Julio Uzctegui_saveButton'))

WebUI.click(findTestObject('Profiles/edit - delete profiles/button_Accept'))
