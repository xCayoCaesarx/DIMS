...
WebUI.setText(findTestObject('Cancelled reason/input_Cancellation Reasons'), namemodify)

WebUI.click(findTestObject('Cancelled reason/td_Order By_to delete'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Cancelled reason/button_Welcome, Julio Uzctegui_deleteButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Cancelled reason/button_Accept - Delete'))
