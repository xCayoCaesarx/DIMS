...
WebUI.setText(findTestObject('Notification List/Edit notification list/input_Email for search'), emailaddressmodify)

WebUI.click(findTestObject('Notification List/Delete notification list/Choose to_tdEditButton'))

WebUI.click(findTestObject('Notification List/Delete notification list/button_Welcome, Julio Uzctegui_deleteButton'))

WebUI.click(findTestObject('Notification List/Delete notification list/button_Accept'))
