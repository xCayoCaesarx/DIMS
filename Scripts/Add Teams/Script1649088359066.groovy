...
WebUI.click(findTestObject('Create Lead/Page_Debt IMS/button_Welcome, Julio Uzctegui_addButton'))

WebUI.setText(findTestObject('Teams/Page_Debt IMS/Page_Debt IMS/input_Team Name'), teamname)

WebUI.selectOptionByValue(findTestObject('Teams/Page_Debt IMS/Page_Debt IMS/Page_Debt IMS/select_Select OneDebt - ImsConsumer Capital_47cd32'), 
    '1', false)

WebUI.selectOptionByValue(findTestObject('Teams/Page_Debt IMS/Page_Debt IMS/Page_Debt IMS/select_Select OneDixon GranadoJose Urribarr_e2400b'), 
    '1002', false)

WebUI.click(findTestObject('Teams/Page_Debt IMS/div_Select a User(s)'))

WebUI.click(findTestObject('Teams/Page_Debt IMS/Page_Debt IMS/div_Select a team members primero'))
