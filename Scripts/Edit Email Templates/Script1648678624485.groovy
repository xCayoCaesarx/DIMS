...
WebUI.setText(findTestObject('Email Templates/Page_Debt IMS/input_Email to search'), 'test aut')

WebUI.click(findTestObject('Email Templates/Page_Debt IMS/button_Available In Client Letters_editButton'))
