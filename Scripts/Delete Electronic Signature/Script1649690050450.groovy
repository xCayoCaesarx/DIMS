...
WebUI.click(findTestObject('Electronic Signature/td_Esign Complete Email_to delete'))

WebUI.click(findTestObject('Notary Network/Delete/button_Welcome, Julio Uzctegui_deleteButton'), FailureHandling.STOP_ON_FAILURE)
