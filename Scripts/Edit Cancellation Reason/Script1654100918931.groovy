...
WebUI.click(findTestObject('Cancelled reason/span_Cancellation Reason'))

WebUI.setText(findTestObject('Cancelled reason/input_Cancellation Reasons'), name)

WebUI.click(findTestObject('Cancelled reason/button_Order By_editButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Cancelled reason/input_Cancellation Reason_modif'), namemodify)

WebUI.click(findTestObject('Cancelled reason/button_Welcome, Julio Uzctegui_saveButton'))

WebUI.click(findTestObject('Cancelled reason/button_Accept - Edit'))
