...
WebUI.setText(findTestObject('Notification List/Edit notification list/input_Email for search'), emailaddress)

WebUI.click(findTestObject('Notification List/Edit notification list/button_Notification Type_editButton'))

WebUI.setText(findTestObject('Notification List/Edit notification list/input_Email 2nd'), emailaddressmodify)

WebUI.click(findTestObject('Competitors/Add Competitors/button_Welcome, Julio Uzctegui_saveButton'))

WebUI.click(findTestObject('Notification List/Edit notification list/button_Accept'))
