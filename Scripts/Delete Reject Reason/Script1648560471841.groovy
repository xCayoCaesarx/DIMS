...
WebUI.click(findTestObject('Reject reasons/delete/Page_Debt IMS/td_No money modified'))

WebUI.click(findTestObject('Reject reasons/delete/Page_Debt IMS/button_Welcome, Julio Uzctegui_deleteButton'))
