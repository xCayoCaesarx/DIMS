...
WebUI.setText(findTestObject('Programs/Page_Debt IMS/input_Programs_for looking'), 'Test DG aut')

WebUI.click(findTestObject('Programs/Page_Debt IMS/button_Office_editButton after search'))
...
WebUI.click(findTestObject('Programs/Page_Debt IMS/div_Consumer select office'))

WebUI.click(findTestObject('Programs/Page_Debt IMS/div_Oliver Law new office'))
...
WebUI.click(findTestObject('Programs/Page_Debt IMS/span_Home Improvements Loans select unaceptable'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.selectOptionByValue(findTestObject('Programs/Page_Debt IMS/select_Credit Analyzer'), 'true', true)
