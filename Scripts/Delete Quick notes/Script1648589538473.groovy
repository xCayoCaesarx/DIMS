...
WebUI.click(findTestObject('Quick notes/Page_Debt IMS/td_Nota test choose o delete'))

WebUI.click(findTestObject('Object Repository/Quick notes/Page_Debt IMS/button_Welcome, Julio Uzctegui_deleteButton'))
