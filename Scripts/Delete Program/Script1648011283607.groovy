...
WebUI.setText(findTestObject('Programs/Page_Debt IMS/input_Programs_for looking'), 'Test DG aut modi')

WebUI.click(findTestObject('Programs/delete program/Page_Debt IMS/td_Office_tdEditButton'))
