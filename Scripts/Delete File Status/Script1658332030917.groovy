...
WebUI.setText(findTestObject('File status/Edit file status/input_File to search'), namemodify)

WebUI.click(findTestObject('File status/Delete file status/td_Workflow_tdEditButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('File status/Delete file status/button_Welcome, Julio Uzctegui_deleteButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('File status/Delete file status/button_Accept'), FailureHandling.STOP_ON_FAILURE)
