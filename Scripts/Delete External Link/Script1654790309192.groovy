...
WebUI.click(findTestObject('External Link/Edit and delete external link/td_URL_tdEditButton'))

WebUI.click(findTestObject('External Link/Edit and delete external link/button_Welcome, Julio Uzctegui_deleteButton'))

WebUI.click(findTestObject('External Link/Edit and delete external link/button_Accept - delete'))
