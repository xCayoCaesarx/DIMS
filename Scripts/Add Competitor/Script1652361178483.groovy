...
WebUI.selectOptionByValue(findTestObject('Competitors/Add Competitors/select_office'), '1', false)

WebUI.setText(findTestObject('Competitors/Add Competitors/input_Competitor_form'), competitorname)
