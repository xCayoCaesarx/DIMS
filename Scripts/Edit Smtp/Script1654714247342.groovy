...
WebUI.setText(findTestObject('Smtp Management/Edit and delete Smtp/input_Smtp search'), serveraddress)

WebUI.click(findTestObject('Smtp Management/Edit and delete Smtp/button_Smtp Server Port_editButton'))

WebUI.setText(findTestObject('Smtp Management/Edit and delete Smtp/input_Smtp Server modify'), serveraddressmodify)

WebUI.click(findTestObject('Smtp Management/Add Smtp/button_Test'))

WebUI.click(findTestObject('Smtp Management/Edit and delete Smtp/button_Welcome, Julio Uzctegui_saveButton'))

WebUI.click(findTestObject('Smtp Management/Edit and delete Smtp/button_Accept'))
