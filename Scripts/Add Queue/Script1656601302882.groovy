...
WebUI.click(findTestObject('Queue/Add Queue/button_Welcome, Julio Uzctegui_addButton'))

WebUI.setText(findTestObject('Queue/Add Queue/input_Queue_name'), queuename)

WebUI.click(findTestObject('Queue/Add Queue/div_Select an Office(s)'))

WebUI.click(findTestObject('Queue/Add Queue/div_Select an Office(s)_p-checkbox-box'))

WebUI.click(findTestObject('Queue/Add Queue/button_Welcome, Julio Uzctegui_saveButton'))
