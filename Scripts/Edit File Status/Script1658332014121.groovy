...
WebUI.setText(findTestObject('File status/Edit file status/input_File to search'), name)

WebUI.click(findTestObject('File status/Edit file status/button_Workflow_editButton'))

WebUI.setText(findTestObject('File status/Edit file status/input_File Status to edit'), namemodify)

WebUI.selectOptionByValue(findTestObject('File status/Edit file status/select_YesNo'), 'true', false)

WebUI.click(findTestObject('File status/Edit file status/button_Welcome, Julio Uzctegui_saveButton'))

WebUI.click(findTestObject('File status/Edit file status/button_Accept'))
