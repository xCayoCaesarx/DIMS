...
WebUI.click(findTestObject('Object Repository/Quick notes/Page_Debt IMS/button_Welcome, Julio Uzctegui_addButton'))

WebUI.setText(findTestObject('Quick notes/Page_Debt IMS/input_Quick Note name'), note)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Quick notes/Page_Debt IMS/div_Select an Office(s)'))

WebUI.click(findTestObject('Object Repository/Quick notes/Page_Debt IMS/div_Select an Office(s)_p-checkbox-box'))
