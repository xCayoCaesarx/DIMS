...
WebUI.setText(findTestObject('Offer Status/edit offer status/input_Offer to search'), offername)

WebUI.click(findTestObject('Offer Status/edit offer status/button_Status_editButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Offer Status/edit offer status/input_Offer to edit'), offernamemodify)

WebUI.click(findTestObject('Offer Status/edit offer status/button_Welcome, Julio Uzctegui_saveButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Offer Status/edit offer status/button_Accept'), FailureHandling.STOP_ON_FAILURE)
