...
WebUI.click(findTestObject('Competitors/Add Competitors/button_Welcome, Julio Uzctegui_addButton'))

WebUI.selectOptionByValue(findTestObject('Community Rules/Add community rule/select_office'), '1', false)

WebUI.setText(findTestObject('Community Rules/Add community rule/input_Community Rule Name_'), communityrulename)

WebUI.click(findTestObject('Community Rules/Page_Debt IMS/span_Show Age'))

WebUI.click(findTestObject('Community Rules/Page_Debt IMS/span_Show Source'))

WebUI.click(findTestObject('Community Rules/Page_Debt IMS/span_Show City'))

WebUI.click(findTestObject('Community Rules/Page_Debt IMS/span_Show Speak Spanish'))
