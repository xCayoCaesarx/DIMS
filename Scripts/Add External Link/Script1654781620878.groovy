...
WebUI.click(findTestObject('Cancelled reason/button_Welcome, Julio Uzctegui_addButton'))

WebUI.setText(findTestObject('Cancelled reason/input_Cancellation Reason_f'), name)

WebUI.selectOptionByValue(findTestObject('Cancelled reason/select_ActiveInactive'), 'true', false)

WebUI.setText(findTestObject('Cancelled reason/input_Order By'), '30')
